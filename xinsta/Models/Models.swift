...
var users: [User] = [User(username: "hojxll_34", bio: "Et per etiam eirmod persecuti, impetus eruditi incorrupte sea te. Option mandamus no duo. Mea id animal dissentiet, nulla affert cu eos, vel zril inciderint id. Ex pri appetere atomorum, ex vis audiam saperet. Nam eu repudiare adipiscing dissentiunt, tale saepe laboramus usu ne. Molestiae comprehensam sed et, mei cu homero salutatus.", profilePhoto: UIImage(named: "gwwdr")!, counts: UserCount(followers: 1346, following: 20, posts: 0), password: "aaaaa1"),
                     User(username: "5xsoold.", bio: "안녕하세요.", profilePhoto: UIImage(named: "66cc0fed32")!, counts: UserCount(followers: 984, following: 89, posts: 0), password: "aaaaa1"),
                     User(username: "x_dfj.zz", bio: "패션 저장소", profilePhoto: UIImage(named: "fashion")!, counts: UserCount(followers: 167, following: 182, posts: 0), password: "aaaaa1"),
                     User(username: "e.xegg34", bio: "이강인 팬 페이지", profilePhoto: UIImage(named: "gangin")!, counts: UserCount(followers: 43346, following: 20, posts: 0), password: "aaaaa1"),
...
var posts: [UserPost] = [UserPost(thumbnailImage: UIImage(named: "5nvzjlzgjfum_m"), caption: "Et per etiam eirmod persecuti, impetus eruditi incorrupte sea te. Option mandamus no duo. Mea id animal dissentiet, nulla affert cu eos, vel zril inciderint id. Ex pri appetere atomorum, ex vis audiam saperet. Nam eu repudiare adipiscing dissentiunt, tale saepe laboramus usu ne. Molestiae comprehensam sed et, mei cu homero salutatus.", createdDate: Calendar.current.date(from: DateComponents(year: 2023, month: 1, day: 15, hour: 20, minute: 15))!, owner: "hojxll_34"),
                         ...
                         UserPost(thumbnailImage: UIImage(named: "mong2"), caption: "", createdDate: Calendar.current.date(from: DateComponents(year: 2023, month: 3, day: 28, hour: 20, minute: 15))!, owner: "mongmong"),
                         UserPost(thumbnailImage: UIImage(named: "mong3"), caption: "", createdDate: Calendar.current.date(from: DateComponents(year: 2023, month: 4, day: 17, hour: 20, minute: 15))!, owner: "mongmong"),
